...
//   return (
//     <div className="bg-[#19272f] text-white p-4 rounded-xl shadow-md flex flex-col items-center mb-6 ">
//       <img src={flag} alt={`${name} flag`} className="w-10 h-10" />
//       <h4 className="mt-2 text-lg font-semibold">{name}</h4>
//       <img src={image} alt={`${name} image`} className="w-24 h-24 mt-2 rounded-lg " />
//     </div>
//   );
// };
...
//         <div className="mt-4 flex justify-center items-center gap-2 bg-black p-3 rounded-md shadow-md w-1/2 mx-auto">
...
//           <li className="text-black font-semibold cursor-pointer"><span className="px-4 py-2 bg-[#03fe9d] rounded-md">Popular Plans</span></li>
//           <li className="text-black cursor-pointer"><span className="px-4 py-2 bg-white rounded-md">Local eSIMs</span></li>
//           <li className="text-black cursor-pointer"><span className="px-4 py-2 bg-white rounded-md">Regions</span></li>
//         </ul>
//       </div>
